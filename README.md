...
- 💡 I love designing architectures that are robust and scalable.
- 🤖 Currently diving deep into RAG, LLMs, Vector Databases (Pinecone), and Next.js.
- 🪴 Always experimenting, building real-world projects, and learning new tech.
- 🎯 Turning my creative ideas into deployed, production-ready applications.
- 🧠 Logic building and AI integration is my happy coding zone.
